 ...
 */
export default function Header({className = '', textSize = 'text-[40px]', topLoc = 'top-[50px]', leftLoc = 'left-[28px]'}:HeaderProps){
  return(
    <div className={`relative font-roundfix text-[#826F5F] ${textSize} ${topLoc} ${leftLoc} ${className}`}>
      Knit
    </div>
  )
}